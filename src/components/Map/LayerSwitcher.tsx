    ...
    <div className="pointer-events-auto flex flex-col rounded-xl border border-gray-200 bg-white/95 shadow-lg backdrop-blur-sm w-44 sm:w-56 max-h-[calc(100vh-10rem)] sm:max-h-[calc(100vh-8rem)] overflow-hidden" style={{ colorScheme: 'light' }}>
      ...
      {open && (
        <>
          ...
          {/* Footer links */}
          <div className="px-3 py-2 border-t border-gray-100 flex-shrink-0 flex flex-col gap-1.5">
            <Link
              to="/encyclopedia"
            ...
            {onUpdateData && (
              <button
                ...
                className="text-xs text-gray-500 hover:text-blue-600 transition-colors text-left flex items-center gap-1"
              >
